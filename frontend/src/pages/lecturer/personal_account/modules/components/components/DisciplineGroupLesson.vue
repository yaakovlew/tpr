...
import { IAttendance } from '../../../../../../models/attendance/attendance';
...
const openGroupAttendanceModal = async () => {
  await store.getLessonsVisiting(props.groupId, Number(props.lesson.lesson_id));
  if (groupStudents.value === null && allGroupStudents.value !== null) {
    ...
    await store.getLessonsVisiting(
      props.groupId,
      Number(props.lesson.lesson_id)
    );
  }
